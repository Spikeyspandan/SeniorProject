...
model1 = load_model(r"C:\Users\spike\Downloads\hand-gesture-recognition-code\final_hand_model.h5")
fList = []
                    ...
                    while VideoThread.cap.isOpened() :
                        ...
                        if results.multi_hand_landmarks:
                            ...
                            for hand_landmarks in results.multi_hand_landmarks:
                                ...
                                if(str(fingercount) == '10'):
                                    self_thread = 2
                                    break
                        
                                prediction = model1.predict([self.prepare(roi)])
